...
<pre><code class="language-bash">npm i vue-prlx</code></pre>
...
<pre><code class="language-xml">&lt;script src="https://cdn.jsdelivr.net/npm/vue/dist/vue.min.js"&gt;&lt;/script&gt;
...
&lt;/script&gt;</code></pre>
      ...
      <pre><code class="language-xml">&lt;div v-prlx&gt;&lt;/div&gt;</code></pre>
      <pre><code class="language-xml">&lt;div v-prlx.background&gt;&lt;/div&gt;</code></pre>
      <pre><code class="language-xml">&lt;div v-prlx="{ speed: 0.2 }"&gt;&lt;/div&gt;</code></pre>

      <h2 class="my">Settings ⚙</h2>
      </div>
      <!-- MAIN -->
    </section>
  </div>
